      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-violet-950 p-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-violet-300 text-lg">Overall Balance: {(analysisResult.overallBalance * 20).toFixed(1)}%</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            {analysisResult.chakras.map((chakra, idx) => {
              ...
              return (
                <div key={idx} className="bg-black/40 backdrop-blur rounded-xl p-6 border border-violet-500/30">
                  ...
                  <div className="space-y-4 text-sm">
                    <div>
                      ...
                      <ul className="text-gray-300 space-y-1">
                        {chakra.effects.map((effect, i) => <li key={i}>• {effect}</li>)}
                      </ul>
                    </div>
                    {chakra.sideEffects.length > 0 && (
                      <div>
                        ...
                        <ul className="text-gray-300 space-y-1">
                          {chakra.sideEffects.map((effect, i) => <li key={i}>• {effect}</li>)}
                        </ul>
                      </div>
                    )}
                    <div>
                      ...
                      <ul className="text-gray-300 space-y-1">
                        {chakra.remedies.map((remedy, i) => <li key={i}>• {remedy}</li>)}
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex gap-4 justify-center">
            <button onClick={() => setCurrentScreen('simulator')}
              className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-blue-600 hover:to-cyan-700 transition-all shadow-lg">
              Try Stack Simulator
            </button>
            <button onClick={() => setCurrentScreen('healing')}
              className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg">
